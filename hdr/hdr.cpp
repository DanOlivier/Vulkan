...
public:
	...
	void buildDeferredCommandBuffer()
	{
		...
		if (displaySkybox)
		{
			...
			offscreen.cmdBuffer.bindVertexBuffers(0, models.skybox.vertices.buffer, offsets);
		...
		offscreen.cmdBuffer.bindVertexBuffers(0, models.objects[models.objectIndex].vertices.buffer, offsets);
	...
	void preparePipelines()
	{
		...
		// Bloom pass
		shaderStages[0] = loadShader(getAssetPath() + "shaders/bloom.vert.spv", vk::ShaderStageFlagBits::eVertex);
		shaderStages[1] = loadShader(getAssetPath() + "shaders/bloom.frag.spv", vk::ShaderStageFlagBits::eFragment);
