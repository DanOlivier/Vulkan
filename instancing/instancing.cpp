...
public:
	...
	void setupDescriptorSet()
	{
		...
		// Instanced rocks
		descriptorSets.instancedRocks = device.allocateDescriptorSets(descripotrSetAllocInfo);
		writeDescriptorSets = {			
		...
		// Planet
		descriptorSets.planet = device.allocateDescriptorSets(descripotrSetAllocInfo);
		writeDescriptorSets = {
